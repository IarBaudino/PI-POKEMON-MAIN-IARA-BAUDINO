...
const getPokemon = async (name) => { //fn asincrona, va a buscar a todos los pokeons y a los poquemons cuando lo soliciten poor name
    
        if (!name) { //verifica si no existe name, si no hay name devuelve true y se trae a todos los pokemons
